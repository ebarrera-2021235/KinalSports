...
import defaultAvatarImg from "../../../assets/img/AvatarUser.png";
...
export const AvatarUser = () => {
    ...
    //Aca se evalu si el usuario tiene una imagen de perfil valida, si no se muestra una imagen por defecto.
    const avatarSrc =
