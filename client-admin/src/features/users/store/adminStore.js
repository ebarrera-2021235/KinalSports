...
export const useFieldsStore = create((set) => ({
    ...
    //Funcion para poder listar las canchas, se llama desde el componente de canchas.
    getFields: async () => {
        try {
    ...
    //Funcion para crear una cancha, se llama desde el componente de canchas.
    ...
    //Funcion para actualizar una cancha, se llama desde el componente de canchas.
    ...
    //Funcion para eliminar una cancha, se llama desde el componente de canchas.
